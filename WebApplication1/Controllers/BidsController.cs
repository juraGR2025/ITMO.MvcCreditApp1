...
namespace WebApplication1.Controllers
{
    public class BidsController : Controller
    {
        ...
        //Добавление атрибута OutputCache с параметрами Duration(продолжительность 
        //кэширования контента в секундах) и Location(место, где размещается кэшированный контент).
        // GET: Bids
